...
int main()
{
    ...
    ;
    CPP_highSW.insert(CPP_highSW.begin(), CPP_highSW.end());
    if ((CPP_highSW == CPP_software))
    {
        std::cout << "All software companies are high-tech companies:";
        for (const auto &element : CPP_highSW)
        {
            std::cout << " " << element;
        }
        std::cout << std::endl;
    ...
    {
        std::cout << "Not all software companies are high-tech companies:";
        for (const auto &element : CPP_highSW)
        {
            std::cout << " " << element;
        }
    ...
    std::cout << "Companies that sell Hardware but not Gaming Software:" << set_difference(CPP_hardware, (intersection(CPP_software, CPP_gaming))) << std::endl;
    return 0;
}
